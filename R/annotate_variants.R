...
#' Identify intersecting variants
#' 
#' From a collection of variants (either a data table, or just a vector of variant IDs),
#' determine which distinct variants cover the same genomic loci. For example,
#' multiple amino acid change mutations (i.e., coding mutations) can intersect
#' when a locus has multiple gene annotations in reference data.
