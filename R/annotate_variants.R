...
annotate_variants <- function(refset = NULL, variants = NULL) {
  if (! is(ces.refset.hg19, "environment")) {
  ...
  # Sometimes an SNV appears to overlap the same gene twice (probably due to redundant gene ranges)
