...
effect_size_SNV <- function(
	...
	if (analysis == "SNV") {
		...
		selection_results = epistasis_gene_level(genes_to_analyze=genes,
...
epistasis_gene_level = function(genes_to_analyze, MAF, trinuc_proportion_matrix,cores=cores, cesa,gene_trinuc_comp,
                                tumor_specific_rate_choice, all_tumors) {
