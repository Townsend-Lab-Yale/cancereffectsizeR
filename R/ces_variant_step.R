...
#' \code{included_with_variant}, \code{included_total}, \code{held_out}, or \code{uncovered}
#' columns, since sample accounting is inherently stage-specific here. Use \code{step_selection_LRT()}
