test_that('MNV detection and identify_maf_variants()', {
  ...
  expect_equal(preloaded[, .(Chromosome, Start_Position, Reference_Allele, Tumor_Allele, patient_id,
...
test_that('identify_maf_variants does not mangle repeated complex identifications,', 
          {
            input_maf = data.table(patient_id = c("patient", "patient", "patient"), 
            ...
            expect_equivalent(complex_maf[is.na(problem), unlist(.(patient_id, Chromosome, Start_Position, 
