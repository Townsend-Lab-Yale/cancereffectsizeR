...
cesa = load_maf(cesa = CESAnalysis("hg19"), maf = maf_file, sample_col = "sample_id", tumor_allele_col = "Tumor_Seq_Allele2")
small_maf = cesa@maf[cesa@maf$Unique_Patient_Identifier %in% c("sample-15", "sample-102"),]
