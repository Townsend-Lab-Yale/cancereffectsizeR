...
maf = preload_maf('tiny.hg38.maf.txt', refset = 'ces.refset.hg38', sample_col = 'Unique_Patient_Identifier')
...
maf = preload_maf('tiny.hg19.maf.txt', refset = 'ces.refset.hg19', sample_col = 'Unique_Patient_Identifier')
