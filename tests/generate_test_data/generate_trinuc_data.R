...
cesa = load_maf(cesa = CESAnalysis(genome = "hg19"), maf = maf_file, sample_col = "sample_id", annotate = F)
...
cesa = load_maf(cesa = CESAnalysis("hg19"), maf = get_test_file("trinuc_rate_test_maf.txt"), annotate = F)
