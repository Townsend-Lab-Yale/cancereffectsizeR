...
There are also a few signatures associated with certain cancer therapeutics (SBS11, SBS31, SBS32, SBS35), so if you are confident that your sample 
...
The cancer type recommendations are based on Extended Data Figure 5 of Alexandrov 2020. The first two columns of the table below, also based on that figure, give the labels accepted by the `cancer_type` argument. (Note: SBS85 and SBS85 are absent from the Alexandrov figure, but they are elsewhere described in the paper as specific to lymphoid neoplasms.)
