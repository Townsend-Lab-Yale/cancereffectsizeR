...
If you want to skip all the details and run through a no-frills cancereffectsizeR analysis, here's the quickstart:
...
sig_genes = sig_genes[, .SD[which.min(qallsubs_cv)], by = 'gene'][order(qallsubs_cv)][1:10]
```
...
plot_effects(cesa$selection$recurrents[gene %in% top_genes], group_by = 'gene',
